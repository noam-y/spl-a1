...
compile : src/Auxiliary.cpp src/main.cpp src/Simulation.cpp src/Settlement.cpp src/Facility.cpp src/FacilityType.cpp src/selectionpolicy2.cpp src/Action.cpp
...
link : bin/main.o bin/Auxiliary.o bin/Simulation.o bin/Settlement.o src/Action.cpp
	g++ -o bin/program bin/main.o bin/Auxiliary.o bin/Simulation.o bin/Settlement.o bin/Facility.o bin/FacilityType.o bin/selectionpolicy2.o src/Action.cpp
